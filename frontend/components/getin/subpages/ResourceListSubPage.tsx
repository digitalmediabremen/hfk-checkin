...
import ResourceListItem, {
    LoadingListItem,
    RESOURCE_LIST_ITEM_DENSITY,
} from "../../common/ResourceListItem";
import { calculateMinHeightSpacing } from "../../common/FormElementBase";
...
const ResourceListSubPage: React.FunctionComponent<ResourceListSubPageProps> =
    ({}) => {
        ...
        const listItemHeight = theme.spacing(
            calculateMinHeightSpacing(RESOURCE_LIST_ITEM_DENSITY)
        ) + 1;
