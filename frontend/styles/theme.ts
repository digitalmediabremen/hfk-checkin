...
const theme = {
    ...
    shadePrimaryColor: function (u: number) { return shadeColor(this.primaryColor, u)},
    shadeSecondaryColor: function (u: number) { return shadeColor(this.secondaryColor, u)},
    shadeDisabledColor: function (u: number) { return shadeColor(this.disabledColor, u)},
    borderRadius: 5,
