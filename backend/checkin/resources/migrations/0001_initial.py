# Generated by Django 3.1.7 on 2021-02-23 20:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(blank=True, choices=[('WAITING', 'benötigt Genehmigung'), ('CONFIRMED', 'ist genehmigt'), ('DENIED', 'abgelehnt')], max_length=25, null=True, verbose_name='State')),
                ('comment', models.CharField(blank=True, max_length=255, null=True, verbose_name='Comment')),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attendance_created', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attendance_modified', to=settings.AUTH_USER_MODEL, verbose_name='Modified by')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_allowd_to', models.ManyToManyField(blank=True, related_name='resources_resource_access_allowed', to=settings.AUTH_USER_MODEL, verbose_name='Access allowed to')),
                ('access_delegates', models.ManyToManyField(blank=True, related_name='resources_resource_access_delegated', to=settings.AUTH_USER_MODEL, verbose_name='Access delegates')),
                ...
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resource_modified', to=settings.AUTH_USER_MODEL, verbose_name='Modified by')),
                ('reservation_delegates', models.ManyToManyField(blank=True, related_name='resources_resource_reservation_delegated', to=settings.AUTH_USER_MODEL, verbose_name='Buchungsverantwortliche')),
            ],
            options={
                'verbose_name': 'Room',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reservation_delegates', models.ManyToManyField(blank=True, related_name='resources_unit_reservation_delegated', to=settings.AUTH_USER_MODEL, verbose_name='Buchungsverantwortliche')),
            ],
            options={
                'verbose_name': 'unit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('created', 'created'), ('cancelled', 'cancelled'), ('confirmed', 'confirmed'), ('denied', 'denied'), ('requested', 'requested')], default='created', max_length=32, verbose_name='State')),
                ...
                ('attendees', models.ManyToManyField(blank=True, related_name='reservations_attending', through='resources.Attendance', to='users.Profile', verbose_name='Attendees')),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reservation_created', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reservation_modified', to=settings.AUTH_USER_MODEL, verbose_name='Modified by')),
                ('resource', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reservations', to='resources.resource', verbose_name='Room')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Organizer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='purpose_created', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='purpose_modified', to=settings.AUTH_USER_MODEL, verbose_name='Modified by')),
        ...
        migrations.AddField(
            ...
            name='reservation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resources.reservation', verbose_name='Reservation'),
        ),
        migrations.AddField(
            model_name='attendance',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attachment_created', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attachment_modified', to=settings.AUTH_USER_MODEL, verbose_name='Modified by')),
            ],
            options={
                'abstract': False,
            },
